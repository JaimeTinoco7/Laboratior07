...
public class EditarPaciente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lstSexo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Masculino", "Femenino", "Otro" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String sexo = lstSexo.getSelectedItem().toString();


        Paciente paciente = new Paciente(nombre, dni, telefono,sexo);
