...
public class ListaPacientes extends javax.swing.JFrame {
    ...
    public ListaPacientes(EditarCitas padre) {
        initComponents();
        this.padre=padre;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (listaPacientes.isEmpty()) {
            JOptionPane.showMessageDialog(
                    this, "No hay pacientes");
            return;
        }

        DefaultListModel<String> modeloLista 
                = (DefaultListModel<String>) lstPacientes.getModel();
        ...
        if (index.isPresent()) {
            lstPacientes.setSelectedIndex(index.getAsInt());
        } else {
            JOptionPane.showMessageDialog(
                    this, 
...
public void agregarPaciente(Paciente paciente) {
        ...
        listaPacientes.addElement(paciente.getTexto());
